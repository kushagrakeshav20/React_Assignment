class Account {
  ...
  const account1 = new SavingAccount(12384737737,"Kushagra Keshav",40000,10000);
  const account2 = new CurrentAccount(151860002537, "Pratik ", 25000, 10000);
  const account3 = new SavingAccount(151860002538, "kundan", 90000, 2000);
  const account4 = new CurrentAccount(151860002539, "Aman", 40000, 5000);
